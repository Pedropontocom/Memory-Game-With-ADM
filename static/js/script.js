...
const checkEndGame = () =>{
  ...
  if(disabledCards.length === 12) {
    document.getElementById("nome_jogador").value = spanPlayer.innerHTML;
    document.getElementById("tentativas").value = moves;
    document.getElementById("tempo").value = timer.innerHTML;
    document.getElementById("formi").submit();
    console.log('chapa921')
...
const createCard = (character) => {
  ...
  front.style.backgroundImage = `url("/static/imgs/${character}.png")`;
